...
public class SellerOrdercancelAsync {
    private Activity activity;
    private RequestModel requestModel;

    public SellerOrdercancelAsync(final Activity activity, RequestModel requestModel) {
        ...
        if (Utility.checkInternetConnection(activity)) {
            ...
            try {
                ...
                Call<ResponseModel> call = apiService.getOrdercancelResponse(jsonObject.toString());
    ...
    private void onpostExecute(ResponseModel response) {
        ...
        if (response != null)
        {
            ...
            ((Seller_OrderdetailActivity) activity).successresponsecancel(response);
